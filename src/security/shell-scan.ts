// Vendored from review-lbgbash/opencode2-src/packages/shell-scan/src/index.ts
// Lightweight bash lexer for slow-command classification.
// Handles quotes, escapes, redirects, $(), ``, <(), comments, compound keywords, etc.
// Returns scanned commands with words (quote-resolved) or opaque reason.
